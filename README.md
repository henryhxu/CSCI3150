...
| 3 | [Threads](lectures/lec4_threads.ppt)<sup>[26](https://pages.cs.wisc.edu/~remzi/OSTEP/threads-intro.pdf)</sup>, <br />[Synchronization 1](lectures/lec5_sync.ppt)<sup>[28](https://pages.cs.wisc.edu/~remzi/OSTEP/threads-locks.pdf)</sup> | Mid-autumn Festival | [Threads](lectures/lec4_threads.pdf), [Sync 1](lectures/lec5_sync.pdf) | [Why Threads Are A Bad Idea (for most purposes)](https://web.stanford.edu/~ouster/cgi-bin/papers/threads.pdf)
