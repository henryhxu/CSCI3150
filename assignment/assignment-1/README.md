# CSCI 3150 Introduction to Operating Systems: Assignment 1
...
Implement a shell program that supports the following functionalities:
...
> [!Note]
>
> Other functions can also be utilized but we recommend using the above functions.
...
> - Test cases in `src/README.md` are provided for validation and are not identical with the test cases for final grading. Several new test cases will be used for final grading.
