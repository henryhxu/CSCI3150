...
4. Run tests with `make test`. We provide one default test case (see Hint) for debugging. Passing the test DOESN'T necessarily mean your program is FULLY correct. You are encouraged to check the output log on your own.
...
2. The default provided test case is:
...
You are encouraged to add your own extra test cases (for example, all writers high priority and all readers low priority) to verify more edge cases.
